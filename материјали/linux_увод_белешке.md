...
2. Додати кориснике ```user1``` и ```user2``` у групу ```project``` (корисници ```user1``` и ```user2``` ће морати да се одјаве и поново пријаве да би промене важиле)
3. Направити директоријум ```Тест```
4. Променити власничку групу директоријума ```Тест``` на ```project```
5. Свим корисницима који су у власничкој групи директоријума ```Тест``` дати дозволу за упис у директоријум:
...
Рецимо да корисник ```user1``` направи датотеку у директоријуму ```Тест``` и групи подстави дозволу за упис у исту:
