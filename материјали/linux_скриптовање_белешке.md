...
* `$параметар` - враћа вредност променљиве под називом параметар
...
## Избегавање (еscape) специјалних карактера
...
наредбу `grep`, коjа се користи за претрагу садржаjа датотека. Могуће jе регуларне
изразе користити и за претрагу путања до датотека или директоријума, у комбинациjи са
функциjом `find`.
