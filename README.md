...
2. Коришћењем [CircuiTikZ](https://ctan.org/pkg/circuitikz)-a нацртати шему произвољног електричног кола које садржи бар x+y елемената. Означити све елементе, као и напоне и струје реактивних елемената чији је број max{x, y, 3}.
